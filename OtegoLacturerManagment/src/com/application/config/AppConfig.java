...
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		System.out.println("**********addResourceHandlers property: "
				+ property);
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		AllRequestInterceptor allUrlInterceptor = WebAppInitializer
				.getApplicationContext().getBean(AllRequestInterceptor.class);
		// adding locale change interceptor
		System.out
				.println("**********addInterceptors adding locale change interceptor");
	...
	public ViewResolver configureViewResolver() {
		...
		System.out.println("**********configureViewResolver property: "
				+ property);
	...
	public JsonUtil jsonUtil() {
		int size;
		if (env.getProperty("GSON_POOL_MIN") != null
				&& env.getProperty("GSON_POOL_MAX") != null) {
	...
	public ApplicationCache applicationCache(JsonUtil jsonUtil) {
		...
		int minCacheServerCon = Integer.parseInt(this.env
				.getProperty("CACHE_SERVER_MIN_CON"));
		int maxCacheServerCon = Integer.parseInt(this.env
				.getProperty("CACHE_SERVER_MAX_CON"));
		int serverConTimeout = Integer.parseInt(this.env
				.getProperty("CACHE_SERVER_CON_TIMEOUT"));
		return new ApplicationCache(Constants.CACHE_PRIFIX, ip, port,
				minCacheServerCon, maxCacheServerCon, serverConTimeout,
				jsonUtil);
	}
