...
public class ApplicationCache {
	...
	public ApplicationCache(String keyPrefid, String serverIp, int serverPort,
			int serverMinCon, int serverMaxCon, int serverConTimeout,
			JsonUtil jsonUtil) {
		...
		this.jedisPool = new JedisPool(config, CACHE_SERVER_IP,
				CACHE_SERVER_PORT);
	...
	public <T> T getMapValue(String key, String field, Class<T> cls,
	...
	public void putMapValue(String key, String field, Object object,
			int expirationSeconds) {
		if (object != null)
		...
		try {
			...
			if (map != null) {
				for (String field : map.keySet()) {
					if (!(field.equals(KEY_SESSION_UPDATED_ON)
							|| field.equals(KEY_SESSION_CREATED_ON) || field
								.equals(KEY_SESSION_USER_IP))) {
