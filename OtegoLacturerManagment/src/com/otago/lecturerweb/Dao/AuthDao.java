...
public class AuthDao {
	...
	@Transactional
	public User createNormalUser(String email, String mobile, String fullName,
			String password) {
	...
	public AuthUser getUserCredentialByUsernameAndPassword(int userId,
			String password) {
		return authUserRepository.findByUserIdAndPassword(userId,
				authUserRepository.getUserPassword(password));
	}
