    ...
    <div class="page-title clearfix">
        <div class="row">
            <div class="col-md-12">
                ...
                <h6><span class="page-active">Events Grid</span></h6>
                ...
                <div class="widget-inner">
                    <div class="event-small-list clearfix">
                        ...
                        <div class="event-small-details">
                            <h5 class="event-small-title"><a href="event-single.php">Nelson Mandela Memorial Tribute</a></h5>
                    ...
                    <div class="event-small-list clearfix">
                        ...
                        <div class="event-small-details">
                            <h5 class="event-small-title"><a href="event-single.php">OVADA Oxford Open</a></h5>
                    ...
                    <div class="event-small-list clearfix">
                        ...
                        <div class="event-small-details">
                            <h5 class="event-small-title"><a href="event-single.php">Filming Objects And Sculpture</a></h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="grid-event-item">
                        ...
                        <div class="box-content-inner">
                            <h5 class="event-title"><a href="event-single.php">January Career Centre Events</a></h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, cum, quidem aut natus odit deleniti placeat quia est quibusdam hic. Quod, minima, excepturi eum repellat tempora... <a href="event-single.php">View Details &rarr;</a></p>
                        </div>
                    </div> <!-- /.grid-event-item -->
                </div> <!-- /.col-md-6 -->
                ...
                <div class="col-md-6">
                    <div class="grid-event-item">
                        ...
                        <div class="box-content-inner">
                            <h5 class="event-title"><a href="event-single.php">Nelson Mandela Memorial Tribute</a></h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, cum, quidem aut natus odit deleniti placeat quia est quibusdam hic. Quod, minima, excepturi eum repellat tempora... <a href="event-single.php">View Details &rarr;</a></p>
                        </div>
                    </div> <!-- /.grid-event-item -->
                </div> <!-- /.col-md-6 -->
                ...
                <div class="col-md-6">
                    <div class="grid-event-item">
                        ...
                        <div class="box-content-inner">
                            <h5 class="event-title"><a href="event-single.php">Building Blocks – York’s Pension Plan</a></h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, cum, quidem aut natus odit deleniti placeat quia est quibusdam hic. Quod, minima, excepturi eum repellat tempora... <a href="event-single.php">View Details &rarr;</a></p>
                        </div>
                    </div> <!-- /.grid-event-item -->
                </div> <!-- /.col-md-6 -->
                ...
                <div class="col-md-6">
                    <div class="grid-event-item">
                        ...
                        <div class="box-content-inner">
                            <h5 class="event-title"><a href="event-single.php">Academic Writing Workshop.</a></h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, cum, quidem aut natus odit deleniti placeat quia est quibusdam hic. Quod, minima, excepturi eum repellat tempora... <a href="event-single.php">View Details &rarr;</a></p>
                        </div>
                    </div> <!-- /.grid-event-item -->
                </div> <!-- /.col-md-6 -->
                ...
                <div class="col-md-6">
                    <div class="grid-event-item">
                        ...
                        <div class="box-content-inner">
                            <h5 class="event-title"><a href="event-single.php">Filming Objects And Sculpture</a></h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, cum, quidem aut natus odit deleniti placeat quia est quibusdam hic. Quod, minima, excepturi eum repellat tempora ... <a href="event-single.php">View Details &rarr;</a></p>
                        </div>
                    </div> <!-- /.grid-event-item -->
                </div> <!-- /.col-md-6 -->
                ...
                <div class="col-md-6">
                    <div class="grid-event-item">
                        ...
                        <div class="box-content-inner">
                            <h5 class="event-title"><a href="event-single.php">OVADA Oxford Open</a></h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, cum, quidem aut natus odit deleniti placeat quia est quibusdam hic. Quod, minima, excepturi eum repellat tempora... <a href="event-single.php">View Details &rarr;</a></p>
                        </div>
                    </div> <!-- /.grid-event-item -->
                </div> <!-- /.col-md-6 -->
