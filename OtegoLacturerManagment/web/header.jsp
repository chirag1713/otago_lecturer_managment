...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <!-- Mirrored from demo.esmeth.com/universe/Blue/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Nov 2016 08:37:07 GMT -->
    <head>
...
<!--                    <li><a href="#">Events</a>
                        <ul>
                            ...
                            <li><a href="event-single.jsp">Event Details</a></li>
                        </ul>
                    </li>-->
                    <li><a href="#">Courses</a>
                        <ul>
                            <li><a href="courses.jsp">Course List</a></li>
...
<!--                    <li><a href="#">Blog Entries</a>
                        <ul>
                            ...
                            <li><a href="blog-disqus.jsp">Blog Disqus</a></li>
                        </ul>
                    </li>-->
<!--                    <li><a href="#">Pages</a>
                        <ul>
        ...
        <header class="site-header" style="background: #004F9F;">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
