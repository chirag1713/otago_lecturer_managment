<!-- begin The Footer -->
<footer class="site-footer" style="background-color: #004F9F;">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <ul class="footer-nav">
                        ...
                        <li><a href="events-list.jsp">Events</a></li>
...
<!-- Mirrored from demo.esmeth.com/universe/Blue/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Nov 2016 08:37:56 GMT -->
</html>