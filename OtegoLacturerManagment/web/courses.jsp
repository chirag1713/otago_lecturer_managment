                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 footer-widget">
                                        <h4>Graduate Diploma in Information Technology</h4>
                                        <ul class="list-links">
                                            <li><a data-toggle="modal" data-target="#myModal">Databases 2 Course</a></li>
                                            <li><a data-toggle="modal" data-target="#myModal">Web 2 - Programming Course</a></li>
                                            <li><a data-toggle="modal" data-target="#myModal">Introductions to Systems Analysis</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 footer-widget">
                                        <h4>Graduate Diploma in Applied Management</h4>
                                        <ul class="list-links">
                                            <li><a data-toggle="modal" data-target="#myModal">Applied Management</a></li>
                                            <li><a data-toggle="modal" data-target="#myModal">Research Methodology</a></li>
            ...
            <div class="modal-body">
                    <div class="widget-inner">
                        <div class="course-search">
                            <h3>Mapping learning outcomes &amp; key concepts, assessments, experiential learning &amp; learner capability</h3>
                                ...
                                <table class="table table-bordered text-center table-responsive">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 22%;">START OF THE COURSE, 2 WEEKS</th>
                                            <th class="text-center" style="width: 46%;">MID-COURSE, 4 WEEKS</th>
                                            <th class="text-center" style="width: 22%;">END OF COURSE, 2 WEEKS</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 0;">
                                                <table class="table table-bordered text-center" style="margin: 0;height: 225px;">
                                                    <tbody><tr>
                                                        <!--<th class="text-center"><input id="input-tags3" class="demo-default selectized" value="science,biology,chemistry,physics" tabindex="-1" style="display: none;" type="text"></th>-->
                                                            ...
                                                            <td style="width: 50%;">
                                                                <p>Class activity,Green initiatives for a major 5 star hotel in Auckland</p>
                                                ...
                                                <table class="table table-bordered text-center" style="margin: 0;height: 225px;">
                                                    <tbody><tr>
                                                        <!--<th class="text-center"><input id="input-tags3" class="demo-default selectized" value="science,biology,chemistry,physics" tabindex="-1" style="display: none;" type="text"></th>-->
                                                            ...
                                                            <td style="width: 25%;">
                                                                <p>Class activity,Students select one article on current issue.</p>
                                                                <p>Students develop approaches to manage the issue.</p>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <p>Class activity,Group presentations CRMfailures</p>
                                                                <p>Class activity, Studentsdevelop aCRM program for a hotel.</p>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <p>Guest lecture: Diversity in hotel industry.</p>
                                                                <p>Class activity,Group presentations,problems related to diversity inhotels.</p>
                                                            </td>
                                                        </tr>
                                                    </tbody></table>  
                                            </td>
                                            <td style="padding: 0;">
                                                <table class="table table-bordered text-center" style="margin: 0;height: 225px;">
                                                    <tbody><tr>
                                                        <!--<th class="text-center"><input id="input-tags3" class="demo-default selectized" value="science,biology,chemistry,physics" tabindex="-1" style="display: none;" type="text"></th>-->
                                                            <td style="width: 50%;">
                                                                <p>Class activity,Discuss one major issue affecting hotel industry.</p>
                                                ...
                                                <table class="table table-bordered text-center" style="margin: 0;height: 225px;">
                                                    <tbody><tr>
                                                        <!--<th class="text-center"><input id="input-tags3" class="demo-default selectized" value="science,biology,chemistry,physics" tabindex="-1" style="display: none;" type="text"></th>-->
                                                            ...
                                                            <td style="width: 50%;">
                                                                <p>How relevant were the initiatives developed? How effective has student contributed to the group work?</p>
                                                            </td>
                                                        </tr>
                                                    </tbody></table>
                                            </td>
                                            <td style="padding: 0;">
                                                <table class="table table-bordered text-center" style="margin: 0;height: 225px;">
                                                    <tbody><tr>
                                                        <!--<th class="text-center"><input id="input-tags3" class="demo-default selectized" value="science,biology,chemistry,physics" tabindex="-1" style="display: none;" type="text"></th>-->
                                                            <td style="width: 25%;">
                                                                <p>Rational for selecting the issue raised in the video?</p>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <p>How has student contributed to the activity? Were the approaches developed innovative and effective?</p>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <p>Student will reflect on their contribution made to the CRM program developed.</p>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <p>Student will reflect on the experience faced by them in diversity.</p>
                                                            </td>
                                                        </tr>
                                                    </tbody></table>  
                                            </td>
