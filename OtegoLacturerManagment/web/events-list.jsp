                    ...
                    <div class="list-event-item">
                        <div class="box-content-inner clearfix">
                            ...
                            <div class="list-event-header">
                                ...
                                <div class="view-details"><a href="event-single.php" class="lightBtn">View Details</a></div>
                            </div>
                            <h5 class="event-title"><a href="event-single.php">January Career Centre Events for Grad Students</a></h5>
