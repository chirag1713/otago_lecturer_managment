...
<div class="container">
    <div class="row">
                    ...
                    <ul class="slides">
                        <li>
                            ...
                            <div class="slider-caption">
                                <h2><a href="blog-single.jsp">When a Doctor's Visit Is a Guilt Trip</a></h2>
                        ...
                        <li>
                            ...
                            <div class="slider-caption">
                                <h2><a href="blog-single.jsp">Unlocking the scrolls of Herculaneum</a></h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit...</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="slider-caption">
                                <h2><a href="blog-single.jsp">Corin Sworn wins Max Mara Art Prize</a></h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit...</p>
                            </div>
                        </li>
                    </ul> <!-- /.slides -->
        ...
        <div class="col-md-4">
            <div class="widget-item" style="height: 402px;">
                <div class="" style="padding: 0;">    
                    <div id="loginbox" class="mainbox col-lg-12 col-md-12 col-sm-12 " style="padding: 0;">                    
                        <div class="panel panel-info"  style="height: 360px;border-color: #00569D;">
                            <div class="panel-heading" style="background: #004884;">
                                <div class="panel-title" style="color: #8ab5d6;font-weight: bold;">Sign In</div>
                            </div>     
                            <div style="padding-top:30px" class="panel-body" >
                                <div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div>
                                <form id="loginform" class="form-horizontal" role="form">
                                    <div style="margin-bottom: 25px;height: 45px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input style="height: 45px" id="login-username" type="text" class="form-control" name="username" value="" placeholder="username or email">                                        
                                    </div>
                                    <div style="margin-bottom: 25px;height: 45px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                        <input style="height: 45px" id="login-password" type="password" class="form-control" name="password" placeholder="password">
                                    </div>
                                    ...
                                    <div style="margin-top:10px" class="form-group">
                                        ...
                                        <div class="col-sm-12 controls">
                                            <a style=" box-sizing: border-box;font-weight: bold;height: 45px;padding: 11px;width: 100%;background: #9DC314;border-color: #9DC314;" id="btn-login" href="#" class="btn btn-success">Login  </a>
                                        </div>
                                    </div>
                                    <div style="float:left; font-size: 90%; position: relative;"><a href="#">Forgot password?</a></div>
                        ...
                        <div class="widget-inner">
                            <div class="blog-list-post clearfix">
                                <div class="blog-list-thumb">
                                    <a href="blog-single.jsp"><img src="images/blog/blog-small-thumb1.jpg" alt=""></a>
                                </div>
                                <div class="blog-list-details">
                                    <h5 class="blog-list-title"><a href="blog-single.jsp">Graduate Open Day at the Ruskin</a></h5>
                                    <p class="blog-list-meta small-text"><span><a href="#">12 January 2014</a></span> with <span><a href="#">3 comments</a></span></p>
                                </div>
                            </div> <!-- /.blog-list-post -->
                            <div class="blog-list-post clearfix">
                                <div class="blog-list-thumb">
                                    <a href="blog-single.jsp"><img src="images/blog/blog-small-thumb2.jpg" alt=""></a>
                                </div>
                                <div class="blog-list-details">
                                    <h5 class="blog-list-title"><a href="blog-single.jsp">Visiting Artists: Giles Bailey</a></h5>
                                    <p class="blog-list-meta small-text"><span><a href="#">12 January 2014</a></span> with <span><a href="#">3 comments</a></span></p>
                                </div>
                            </div> <!-- /.blog-list-post -->
                            <div class="blog-list-post clearfix">
                                <div class="blog-list-thumb">
                                    <a href="blog-single.jsp"><img src="images/blog/blog-small-thumb3.jpg" alt=""></a>
                                </div>
                                <div class="blog-list-details">
                                    <h5 class="blog-list-title"><a href="blog-single.jsp">Workshop: Theories of the Image</a></h5>
                                    <p class="blog-list-meta small-text"><span><a href="#">12 January 2014</a></span> with <span><a href="#">3 comments</a></span></p>
                                </div>
                            </div> <!-- /.blog-list-post -->
                        </div> <!-- /.widget-inner -->
                        ...
                        <div class="widget-inner">
                            <div class="event-small-list clearfix">
                                ...
                                <div class="event-small-details">
                                    <h5 class="event-small-title"><a href="event-single.jsp">Nelson Mandela Memorial Tribute</a></h5>
                            ...
                            <div class="event-small-list clearfix">
                                ...
                                <div class="event-small-details">
                                    <h5 class="event-small-title"><a href="event-single.jsp">OVADA Oxford Open</a></h5>
                            ...
                            <div class="event-small-list clearfix">
                                ...
                                <div class="event-small-details">
                                    <h5 class="event-small-title"><a href="event-single.jsp">Filming Objects And Sculpture</a></h5>
